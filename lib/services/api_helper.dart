...
import 'package:weather_application/models/hourly_weather.dart';
import 'package:weather_application/models/weather.dart';
import 'package:weather_application/models/weekly_weather.dart';
import 'package:weather_application/services/geolocator.dart';
import 'package:weather_application/utils/logging.dart';
  ...
  static Future<Map<String, dynamic>> _fetchData(String url) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        printWarning('Failed to load data $url: ${response.statusCode}');
